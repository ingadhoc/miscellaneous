...
class KeyResult(models.Model):
    ...
    company_id = fields.Many2one('res.company', related="objective_id.company_id", stored=True)
    department_id = fields.Many2one('hr.department', related="objective_id.department_id", stored=True)
